...
from utils.string_utilities import standardize_uri, remove_parenthesis
...
class CSVJsonGenerator():
    ...
    def standardize_label_format(self,
        ...
        Args:
            label: a label with underscores.
        """
    ...
    def get_pref_label(self,
        ...
        Use this method to select a preferred label of a synonym set.
        ...
        if not pref_label:
            ...
            pref_label = labels[0]
            clean_pref_label = remove_parenthesis(pref_label)
            if clean_pref_label != pref_label:
                all_labels.append(clean_pref_label)
