...
if __name__ == "__main__":
    ...
    parser.add_argument("-t", "--tsv",
                        ...
                        required = True,
                        type = str,
                        help = "TSV file(s) with gold annotations. Each line should have three columns at least: entity1 URI, entity2 URI, annotation ('x' or 'o'). The namespaces of entity1 & entity2 are retrieved from the TSV filename (example: AAS-PDS.tsv).")
