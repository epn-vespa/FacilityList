...
with open('/Users/ldebisschop/PycharmProjects/FacilityList/data/SPASE/scripts/added-spase-id_manually.json', 'r') as f2:
    data2 = json.load(f2)
...
with open('/Users/ldebisschop/PycharmProjects/FacilityList/data/obs-facilities_vocabulary/obsfacility-vocabulary_v_1.3.json', 'w') as f:
